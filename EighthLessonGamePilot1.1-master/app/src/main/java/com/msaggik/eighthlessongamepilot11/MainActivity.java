    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        volumeOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                plane = findViewById(R.id.imageView);
                plane.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
                planeWidth = plane.getMeasuredWidth();
                planeHeight = plane.getMeasuredHeight();
                    ...
                    public boolean onTouch(View view, MotionEvent event) {
                        switch (event.getAction()) {
                            case MotionEvent.ACTION_DOWN:
                                ...
                                initX = view.getX() - event.getRawX();
                                initY = view.getY() - event.getRawY();
                                break;
        
                            case MotionEvent.ACTION_MOVE:
                                
                                view.animate()
                                        .x(event.getRawX() + initX)
                                        .y(event.getRawY() + initY)
                                        .setDuration(0)
                                        .start();
                                break;
                            ...
                            case MotionEvent.ACTION_UP:
                                ...
                                int y = (int) view.getY();
                                if (y < 0 || y + planeHeight > screenHeight) {
                                    
                                    view.animate()
                                            .x(screenWidth - planeWidth) 
                                            .y(screenHeight/2 - planeHeight/2)
                                            .setDuration(0)
                                            .start();
                                }
                                break;
